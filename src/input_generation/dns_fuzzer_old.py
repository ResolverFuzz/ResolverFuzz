...
domain_self_default = "test0.qifanzhang.com"
...
class DNSQR:
    ...
    def getDNSQR(self):
        return {"QNAME": self.QNAME_HEX, "QTYPE": self.QTYPE, "QCLASS": self.QCLASS}
...
class DNSRR:
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "RDATA": self.RDATA_HEX}
...
class DNSRRA(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "IPv4": self.IPv4_HEX}
...
class DNSRRNS(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "NS": self.NS_HEX}
...
class DNSRRCNAME(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "CNAME": self.CNAME_HEX}
...
class DNSRRDNAME(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "DNAME": self.DNAME_HEX}
...
class DNSRRSOA(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "MNAME": self.MNAME_HEX, "RNAME": self.RNAME_HEX, "SERIAL": self.SERIAL,
                "REFRESH": self.REFRESH, "RETRY": self.RETRY, "EXPIRE": self.EXPIRE, "MINIMUM": self.MINIMUM}
...
class DNSRRMX(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "PREFERENCE": self.PREFERENCE, "MX": self.MX_HEX}
...
class DNSRRTXT(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "TXTLEN": self.TXTLEN, "TXT": self.TXT_HEX}
...
class DNSRRAAAA(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "IPv6": self.IPv6_HEX}
...
class DNSRRRRSIG(DNSRR):
    ...
    def getDNSRR(self):
        return {"RRNAME": self.RRNAME_HEX, "RTYPE": self.RTYPE, "RCLASS": self.RCLASS, "TTL": self.TTL,
                "RDLEN": self.RDLEN, "TypeCovered": self.TypeCovered, "Algorithm": self.Algorithm,
                "Labels": self.Labels, "OrigTTL": self.OrigTTL, "SigExpi": self.SigExpi, "SigInce": self.SigInce,
                "KeyTag": self.KeyTag, "Signer": self.Signer_HEX, "Sig": self.Sig_HEX}
...
class DNSFuzzer:
    ...
    def __init__(self, 
        ...
        top_1m="./top-1m.csv", 
        domain_self=domain_self_default):
        self.TXID = 0
        self.QR = 0
        self.OPCODE = 0
        self.AA = 0
    ...
    def DumpPkt(self):
        pkt = {"TXID": self.getTXID(), "QR": self.getQR(), "OPCODE": self.getOPCODE(), "AA": self.getAA(),
               ...
               "CD": self.getCD(), "RCODE": self.getRCODE(), "QDCOUNT": self.getQDCOUNT(), "ANCOUNT": self.getANCOUNT(),
               "NSCOUNT": self.getNSCOUNT(), "ARCOUNT": self.getARCOUNT(), "QD": self.getQD(), "AN": self.getAN(),
               "NS": self.getNS(), "AR": self.getAR()}
        print(pkt)
    ...
    def makeName(self):
        ...
        name = ""
        label_number_base = 0
        choice_base = random.randint(9, 16) # ignore TLD and SLD lists
        if choice_base == 0:
            name = "."
            label_number_base = 0
        elif choice_base <= 4:
    ...
    def Response(self):
        ...
        rr_count = an_count + ns_count + ar_count
        ...
        for i in range(0, rr_count):
            ...
            if random.randint(0, 1) == 0:
                ...
                rtype = DNSTypesCommon.valueList()[random.randint(0, len(DNSTypesCommon) - 1)]
            rclass = qclass
        ...
        return self.makeDNSHeaderCount(), self.makeDNSANNSAR()
...
if __name__ == "__main__":
    ...
    dns_query = df.Query()
    print(dns_query.hex())
    send_udp("128.195.180.83", 12345, "1.2.3.4", 53, dns_query)
    header_count, annsar = df.Response()
    dns_response = df.makeTXID() + header_count + df.makeQD() + annsar
    send_udp("128.195.180.83", 12345, "1.2.3.4", 53, dns_response)
